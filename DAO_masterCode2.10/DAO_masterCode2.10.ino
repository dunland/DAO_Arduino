...
/*OTHERING MACHINES v.2.10 Version für Videoaufnahme: mehrere Geräte sollten kommunizieren können
  15.11.2018
    LED bug fix: RGB LED uses current sinking, thus subtraction from 255 necessary!
...
void lightRGB()
{
  red = 255 - (redAb / abTot) * 255;
  green = 255 - (greenAb / abTot) * 255;
  blue = 255 - (blueAb / abTot) * 255;
