...
/*OTHERING MACHINES v.2.05
 * RGB LED reparieren: kein türkises Dauerleuchten mehr (PINOUT was wrong)
 * Signalübertragung bei 2 Geräten funktioniert
 * 
...
//-----------------------------------------------Negative Reaction
//1. instant vibrate
//2. lights RGB for duration of waiting time
//3. LEDs off, play tone
//4. subsiding: lights RGB for 10s
