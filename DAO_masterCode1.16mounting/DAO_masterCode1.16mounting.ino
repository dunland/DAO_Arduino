/*OTHERING MACHINES v.1.16A.)
 * for mass mounting
 * adjustable variables: midpoint (voltage), ampThreshold
 * frequency as incomingData (not median)
 * random waitFactor
 * LED blink after db fillup
...
byte slopeTol = 200;//slope tolerance- higher for steep waves
...
void checkIncomingData(int incomingData) {
  if (incomingData > 300 && incomingData <= 3000) {
