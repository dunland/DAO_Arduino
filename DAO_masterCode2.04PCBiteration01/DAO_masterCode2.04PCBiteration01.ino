...
/*OTHERING MACHINES v.2.04
 * PCB iteration 01:
 * testing new PCBs (otheringmachines02c.pro)
 * behavior: regular frequency detection & assessment & response
 * shorter vibration for damage prevention
 * Speaker out = Pin 8
